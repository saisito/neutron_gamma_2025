...
files = [
    {"id": "1rmvOEJvVY90sLoXoSx6gfoMAi7DIi5Rq", "name": "ale.tar.gz"},
   # {"id": "1Gj9wUaT_dyvA8ECjrYRkmEZM2v3E9Ads", "name": "preprocessed_data_pure/X_test.csv"},
   # {"id": "1GuI8ELpt5Kz-k0pOpm3SByESFiZCeC_U", "name": "preprocessed_data_pure/X_train.csv"},
   # {"id": "1vjSEFSmXzE2pWDjBI-gbH1XSFGAEj6sM", "name": "preprocessed_data_pure/y_test.csv"},
   # {"id": "15XY_Md9YdctsHtwUA1ctJqDaZXYIwWPU", "name": "preprocessed_data_pure/y_train.csv"},
    {"id": "1z4W9pEa04ZUmKm5dlJaJd5MNwvaW7JyA", "name": "preprocessed_data_salt/X_test.csv"},
    {"id": "1PlFX3ZSkcWu-_vfJwlFXFXfNEtBZwFLT", "name": "preprocessed_data_salt/X_train.csv"},
    {"id": "10b5IPjvlaDks6IcWS1CgOO_76yk8Kmnm", "name": "preprocessed_data_salt/y_test.csv"},
    {"id": "1eYIBvHxazIVCnoycoLrArcY7yl-uJuGA", "name": "preprocessed_data_salt/y_train.csv"},
   # {"id": "1Gj9wUaT_dyvA8ECjrYRkmEZM2v3E9Ads", "name": "filtered_AmBe_pure/AmBe_cdparafb.csv"},
   # {"id": "1GuI8ELpt5Kz-k0pOpm3SByESFiZCeC_U", "name": "filtered_AmBe_pure/AmBe_desnuda.csv"},
   # {"id": "1vjSEFSmXzE2pWDjBI-gbH1XSFGAEj6sM", "name": "filtered_AmBe_pure/AmBe_plomo.csv"},
   # {"id": "15XY_Md9YdctsHtwUA1ctJqDaZXYIwWPU", "name": "filtered_AmBe_pure/fondo.csv"},
    {"id": "1bixnzQK63uE6KWXpC2DxN7dh62rC9Aai", "name": "filtered_AmBe_salt/AmBe_cdparafb.csv"},
    {"id": "1m4ZbkTGRTZTlrF0i1WVgMg5OFBxavIFQ", "name": "filtered_AmBe_salt/AmBe_desnuda.csv"},
    {"id": "1c5YgDb064pQUHyNQansJs_0ZE8_71VMN", "name": "filtered_AmBe_salt/AmBe_plomo.csv"},
    {"id": "1jcKmKjEsCYJEHb0P7yEV__OXq2VlSNKC", "name": "filtered_AmBe_salt/fondo.csv"},
